    ...
    return (
      <div className="kanbanBoard">
        {filteredTickets.map((column) => (
          <div key={column.name} className="kanbanColumn">
            <div className="columnHeadingContainer">
              <div className="leftb">
                ...
                {groupBy === "priority" ? (
                  <div className="columnHeadingText">
                    {" "}
                    {priorityNames[column.columnName]}
                  </div>
                ) : (
                  <div className="columnHeadingText"> {column.columnName}</div>
                )}
                <div className="columnHeadingCount">
                  {column && column.tickets && column.tickets.length}
                </div>
              </div>
            ...
            {column.tickets &&
              column.tickets.map((ticket) => (
                <Page key={ticket.id} ticket={ticket} />
              ))}
          </div>
        ))}
      </div>
